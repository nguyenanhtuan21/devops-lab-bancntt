...
namespace Api.BaseController
{
    ...
    public class BaseController<T> : ControllerBase
    {
        ...
        public virtual IActionResult AddRecord([FromBody] T record)
        {
            ...
            {
                if (exception.Message.Equals(EmployeeException.DublicateCode))
                {
                    return StatusCode(StatusCodes.Status400BadRequest, new ErrorResult(Core.Enums.AmisErrorCode.DuplicateCode, EmployeeMessage.DublicateCode, null, null, null));
                }
